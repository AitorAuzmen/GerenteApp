...
INSERT INTO `erreserbak` VALUES
(1,'Iker Gomez','688112233',4,'2026-03-27 14:00:00',58.50,0,NULL,2,2),
(2,'Nora Ruiz','699223344',2,'2026-03-27 21:00:00',31.00,1,'faktura_2.pdf',4,5),
(3,'Ane Soto','677445566',6,'2026-03-28 15:30:00',96.00,0,NULL,2,7);
...
INSERT INTO `eskariak` VALUES
(1,58.50,'prestatzen',1,2,2),
(2,31.00,'amaituta',2,4,5),
(3,96.00,'zerbitzatuta',3,2,7);
...
INSERT INTO `eskariak_has_produktuak` VALUES
(1,1,2,24.00),
(1,5,3,4.50),
(1,6,3,6.00),
(2,2,1,11.50),
...
INSERT INTO `hornitzaileak` VALUES
(1,'Baserri Fresh','944000111','Bilbo, Zorrotzaurre 12'),
(2,'Edari Banaketa','943111222','Donostia, Portua 8'),
(3,'Ipar Haragia','945222333','Gasteiz, Industrialdea 4');
...
INSERT INTO `langileak` VALUES
(1,'Aitor','Auzmend','Admin',1,'123',1,0,0),
(2,'Leire','Agirre','leire',1002,'1234',2,0,1),
(3,'Unai','Mendizabal','unai',1003,'1234',3,0,0),
(4,'June','Ibarra','june',1004,'1234',2,0,1),
(5,'Mikel','Otaegi','mikel',1005,'1234',3,0,0);
...
INSERT INTO `materialak` VALUES
(1,'Kutxak',2.00,120,1),
(2,'Ezpainzapiak',1.50,200,2),
(3,'Plater txikiak',3.20,80,1);
...
INSERT INTO `osagaiak` VALUES
(1,'Ogia',0.45,80,1),
(2,'Tomatea',0.30,60,1),
(3,'Urdaiazpikoa',1.10,35,3),
(4,'Gazta',0.80,40,3),
(5,'Letxuga',0.25,30,1),
(6,'Oilaskoa',1.60,25,3),
(7,'Kafe aleak',0.20,120,2),
(8,'Ura',0.15,200,2),
(9,'Pasta orea',0.90,28,1),
(10,'Arrautza',0.22,90,1),
(11,'Patatak',0.35,75,1),
(12,'Hanburgesa haragia',1.90,22,3);
...
INSERT INTO `produktuak` VALUES
(1,'Hanburgesa klasikoa',12.00,'nagusia',18),
(2,'Caesar entsalada',11.50,'hasierakoa',14),
(3,'Pizza margarita',12.50,'nagusia',10),
(4,'Kroketak',8.50,'anoa',24),
(5,'Kafea',1.50,'edaria',90),
(6,'Ura 50cl',2.00,'edaria',120),
(7,'Sandwich mistoa',6.50,'mokadua',20),
(8,'Txuleta',13.00,'nagusia',12);
...
INSERT INTO `produktuak_has_osagaiak` VALUES
(1,1,1),
(1,2,1),
(1,4,1),
(1,12,1),
...
-- Dump completed on 2026-03-26 11:47:21